/*
 * BOLT_BERT_OUR - Using custom softmax implementation (softmax_fix_our)
 */
...
int main(int argc, char **argv) {
    ...
    cout << ">>> Evaluating Bert (OUR SOFTMAX VERSION)" << endl;
    cout << "-> Role: " << party << endl;
    cout << "-> Address: " << address << endl;
    cout << "-> Port: " << port << endl;
    cout << "<<<" << endl << endl;

    Bert_Our bt(party, port, address, path + "/weights_txt/", pruning);
